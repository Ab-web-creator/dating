...
import './stories.css'
import Ismoil_svg from '../../images/Ismoil.svg'
      ...
      <div className="separate_into_two_columns">
        <main className="sep_part1">
          ...
          <div className='main_text'>
            ...
            >
              <p >
                <sup>1</sup> Масалан, Суҳайлий “Равд ул-унуф” китобида, Абулфидо “Ал-бидоя ван-ниҳоя” китобида, Табарий ўзининг “Тарих” асарида.  Салабий ёзишича, Соро Биби бир сафар ҳатто яниб: “Сен энди мен билан бир маконда яшамаяжаксан” деб туриб оладилар («Ароис» китоби, 81-бет).
              </p>
            </div>
            <p className='vitalic' onClick={() => handleSupClick(1)}>

              Соро онамиз Ҳожар Бибини рашк қилар эди. Бу ҳақда кўп олимлар баён этганлар.<sup>1</sup> Табарийнинг ёзишича, Соро Биби бир эмас, икки марта Ҳожар онамизни уйдан қувганлар.
            </p>
            ...
            <p>
              Бу гапдан расулуллоҳ жуда қаттиқ хафа бўлдилар. Ахир, Исмоил (а.с.) ҳам у кишининг ўғли эди-да!
              Лекин Оллоҳ расулуллоҳга ваҳий нозил қилиб деди: «Соронинг айтганини қил. Чунки зурриятинг ҳақида берган ваъдам Исҳоқ орқали давом этади. Исмоил ва Ҳожар учун ҳам ташвишланма.
              Мен уларни сақлайман. Исмоилнинг наслидан катта бир халқ яратаман. Чунки у ҳам сенинг фарзандинг», деди.
            </p>
            <p></p>
          </div>
          ...
          <div className='main_text'>
            ...
            >
              <p >
                <sup>2</sup>    Афиф Абдул-Фаттоҳ Табборанинг “Маъал-анбия фил-Қуръанил-карим” китобида ёзилишича, Оллоҳ субҳанаҳу ва таоло Соронинг истагини қабул қилиб, Иброҳим (а.с.) га Ҳожар онамизни ўғли билан бирга бошқа манзилга кўчиришни амр қилган.
              </p>
            </div>
            <p onClick={() => handleSupClick(2)}>
              Ҳа, бу ҳам Оллоҳдан келган бир синов<sup>2</sup> эди. Фарзанддан айрилиш осонми? Ахир Исмоил (а.с.) — Иброҳим пайғамбарнинг тўнғич ўғли эдилар.
            </p>
          </div>
          ...
          <div className='main_text'>
            ...
            <p className="boldItalic">«Эй Раббимиз, ҳақиқатда мен ўз зурриятимни сенинг муҳаррам уйинг ёнига, гиёҳсиз водийга жойлаштирдим. Эй Раббимиз, намозда муқим бўлишлари учун, бас, Ўзинг одамлардан баъзи кишилар қалбини уларга талпинадиган қил ва уларни мевалардан ризқлантир. Шояд шукр қилсалар» <span className="vitalic">(Иброҳим сураси 14:37).</span>
            </p>
          ...
          <div className='main_text'>
            ...
            <p className="vitalic" onClick={() => handleSupClick(3)}>
              Пайғамбаримиз (с.а.в.) нинг ҳадисларида ёзилишича, Ҳожар биби Исмоил (а.с.) ни бир бутанинг соясига ётқизиб, мешни бир шохга осади. Ўзи ҳам, боласи ҳам ана шу мешдан сув ичар эдилар.<sup>3</sup>    Бир муддатдан сўнг сув тамом бўлди.
            </p>
            <p></p>
          </div>
          ...
          <div className='main_text'>
            ...
            >
              <p >
                <sup>4</sup> Азрақий. “Аxбори Макка”, 1-жилд, 55-бет.
              </p>
            </div>
            <p className="vitalic" onClick={() => handleSupClick(4)}>
              Сув тугагач, Ҳожар (р.а.): “Боламнинг ўлишини кўрмай”, деб  бироз масофа нарига бориб ўтиради.<sup>4</sup>
            </p>
            <p></p>
          </div>
          ...
          <div className='main_text'>
            ...
            >
              <p >
                <sup>5</sup>  Китобларда ёзилишича, бу икки тепа — Сафо ва Марва тепаликлари эди. Ўшанда Ҳожар Биби бу икки тепа орасида етти марта бориб келган экан (Имом Бухорий, Байҳақий, Қуртубий ва бошқалар).
              </p>
            </div>

            <p className="vitalic" onClick={() => handleSupClick(5)}>
              Кейин бир тепаликка чиқиб сув излаб атрофга боқади. Бирор товуш эшитармиканман, деб ҳар тарафга тикилади, лекин на бир сес эшитилади ва на бирор кимса кўринади. Кейин чопиб пастга тушади-да кейинги тепаликнинг устига чиқади, у ерда ҳам жавдираб атрофга боқади, лекин ҳеч кимни кўрмайди. Шу тариқа она зор-зор йиғлаб икки тепа  орасида сарсон бўлади.<sup>5</sup>
            </p>



            <p className="vitalic">
              Шунда Оллоҳнинг фариштаси аён бўлиб: «Ҳожар, Ҳожар, нега йиғлайсан? Қўрқма, додинглар арши аълога етди.
              Қани тур, болани турғиз! Оллоҳ унинг наслидан буюк халқ яратур», деди.
            </p>
          ...
          <div className='main_text'>
            ...
            <p className="vitalic" onClick={() => handleSupClick(6)}>
              ...
              Шундоғ қилиб, Оллоҳ таоло ҳамиша уларга ёр бўлди. Исмоил (а.с.) чўлда ўсиб-улғайиб, моҳир тирандоз бўлдилар. Онаси у кишини кейинчалик мисрлик бир қизга уйлантиради.<sup>6</sup>
            </p>
            <p></p>
          </div>
          ...
          <article className='nav_arrows'>
            <div className='flex_it space_between'>
              ...
              <div className='central_div'>
                <div>
                  <p>Исмоил (а.с.) қиссаси</p>
                </div>
              </div>

              <div style={{ marginRight: '0px' }} onClick={() => navigate('/qisas-uzbek/zabihullah')}>
                <div className='indicator'>
                  <span className=' bottom_arrows_for_qisas' >  Забиҳ</span>
                </div>
                <div>
